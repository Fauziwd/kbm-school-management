<div class="bg-purple-700 px-4 sm:px-6 py-3 flex items-center shadow-xl justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    ...
    <div class="relative">
        @auth
            ...
            <div class="absolute top-0 right-0 mt-12 -mr-6 bg-opacity-20 shadow-lg text-purple-900 rounded-bl-lg rounded-br-lg" style="backdrop-filter: blur(10px); z-index: -1;">
