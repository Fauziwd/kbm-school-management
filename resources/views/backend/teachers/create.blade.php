...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Form Anggota Baru</h2>
            </div>
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('teacher.store') }}" method="POST" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                      <div class="relative">
                        <input name="profile_picture" class="hidden" type="file" id="profilePictureInput">
                        <label for="profilePictureInput" class="cursor-pointer bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
                          Upload Gambar
                        </label>
